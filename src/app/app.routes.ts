...
export const routes: Routes = [
  ...
  },
  {
    path: 'consultations',
    loadComponent: () =>
      import('./component/consultations/user-consultations.component').then((m) => m.UserConsultationsComponent),
  },
  {
    path: 'staff-orders',
    loadComponent: () =>
  ...
  },
  {
    path: 'commissions',
    loadComponent: () =>
      import('./component/commissions/consultation-commissions.component').then((m) => m.ConsultationCommissionsComponent),
  },
  {
    path: 'myinfor',
